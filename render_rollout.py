...
flags.DEFINE_string(
    "rollout_path",
    'rollout/WaterDropSample/rollout_test_1.pkl',
...
def main(unused_argv):
    ...
    gif = animation.PillowWriter(fps=30)
    unused_animation.save(FLAGS.rollout_path.replace("pkl", "gif"), writer=gif)
